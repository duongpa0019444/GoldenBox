            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <div class="d-flex align-items-center">
                        ...
                        <!-- Menu Toggle Button -->
                        <div class="topbar-item">
                            <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Chào mừng ADMIN {{Auth::user()->name}}!</h4>
                        </div>
                    </div>
...
>>>>>>> 17d4d96a776f010598a17eafd006c45f04996fff
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="order">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="/admin/order/list">Lịch sử đơn hàng</a>
                                </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="user">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="/admin/user/list">Danh sách</a>
                                </li>

                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="/admin/user/create">Thêm người quản trị</a>
                                </li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        </script> &copy;  <iconify-icon icon="iconamoon:heart-duotone" class="fs-18 align-middle text-danger"></iconify-icon> <a
                            href="#" class="fw-bold footer-text" target="_blank">GOLDENBOX</a>
                    </div>
                </div>
            </div>
<<<<<<< HEAD
